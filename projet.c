...
pthread_t students[student_num]; //declaring thread for students where student num is the no of students
...
pthread_create( &students[x], NULL, student_actions, (void*) &student_ids[x] );
...
if ( waiting_room_chairs[z] == student_id ) { return 1; }
